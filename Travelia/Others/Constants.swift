...
let personIconImage = UIImage(named: "person_icon")
let emailIconImage = UIImage(named: "passlock_image")
let passwordIconImage = UIImage(named: "passlock_image")
let rePasswordIconImage = UIImage(named: "passlock_image")

let textFieldIconX = 0.0
let textFieldIconY = 0.0
